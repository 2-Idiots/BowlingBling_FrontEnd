    ...
    <div className="mt-10 max-w-5xl mx-auto px-4">
      ...
      <div className="flex gap-2 mt-2 text-lg">
        ...
        <div className="text-gray-700">
          {session?.user?.email || 'user@bowling.com'}
        </div>
      </div>
      <div className="grid md:grid-cols-3 gap-4 mt-12 mb-20">
        ...
        <Link
          href="/lesson/register/category"
          className="shadow-lg rounded-lg flex flex-col justify-between p-4 gap-12 hover:shadow-xl"
        >
          <GrChapterAdd className="text-xl md:text-3xl" />
          <div>
            <h1 className="font-semibold">레슨 등록</h1>
            <h2 className="text-sm text-gray-500">나의 레슨 등록하기</h2>
          </div>
        </Link>
        <Link
          href="#"
          className="shadow-lg rounded-lg flex flex-col justify-between p-4 gap-12 hover:shadow-xl"
        >
          <LuFileCheck className="text-xl md:text-3xl" />
          <div>
            <h1 className="font-semibold">레슨 관리</h1>
            <h2 className="text-sm text-gray-500">나의 레슨 관리하기</h2>
          </div>
        </Link>
        <Link
          href="/users/likes"
        ...
        >
          ...
          <div>
            <h1 className="font-semibold">찜한 레슨</h1>
            <h2 className="text-sm text-gray-500">찜한 레슨 모아보기</h2>
          </div>
        </Link>
        <Link
          href="/users/comments"
