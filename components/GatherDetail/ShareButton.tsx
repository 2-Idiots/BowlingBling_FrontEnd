...
export default function ShareButton({ data }: { data: GatheringType }) {
                ...
                <Dialog.Panel className="w-full max-w-xl transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="mt-5 flex gap-4 items-center">
                    ...
                    <div className="flex items-center gap-1 text-sm">
                      ...
                      <div className="text-gray-800">{data?.leadername}</div>
                      <div className="text-gray-600">·</div>
                  ...
                  <div className="mt-6 grid grid-cols-2 md:grid-cols-3 gap-4 mb-6">
                    ...
                    {typeof window !== 'undefined' && (
                      <Link
                        href={`mailto:?subject=번개 모임 공유하기&body=${window.location.href}`}
                        className="border border-gray-300 font-semibold rounded-lg px-6 py-4 flex items-center gap-4 hover:bg-black/5"
                      >
                    ...
                    <button
                      ...
                      className="border border-gray-300 font-semibold rounded-lg px-6 py-4 flex items-center gap-4 hover:bg-black/5"
                    >
                      <RiKakaoTalkFill className="text-xl md:text-3xl text-yellow-400" />
                      카카오톡
                    </button>
                  </div>
                </Dialog.Panel>
