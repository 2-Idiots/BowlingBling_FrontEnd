...
export default function CenterMap() {
  ...
  const { data: centers, isSuccess } = useQuery('map-centers', () =>
    fetchCenters(),
  )
  ...
  const loadKakaoMap = () => {
    window.kakao.maps.load(() => {
      ...
      centers?.content.forEach((center: CenterType) => {
        ...
        const content = `<div class="custom_overlay">${center.businessName}</div>`
